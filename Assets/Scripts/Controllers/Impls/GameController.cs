...
namespace Controllers.Impls
{
    ...
    /// Логіки обробки зіткнень та перевірок гравця потенційно також корисно винести в окремі сервіси,
    /// проте в рамках невеликої логіки прототипу вирішено залишити її задля легкості реалізації в контроллері.
